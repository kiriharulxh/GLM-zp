...
with open("/Users/liuxinghan/Downloads/PCLUE/datasets/pCLUE_test_public_1.json") as f:
    ...
    for line in ls:
        ...
        if info["type"] == "generate":
            ...
            out_info["targets_pretokenized"] = info["target"]
            gen_out.append(json.dumps(out_info, ensure_ascii=False))
        else:
            continue
...
with open("/Users/liuxinghan/Downloads/pclue-gen-test.jsonl", "w") as f:
    f.write("\n".join(gen_out))
